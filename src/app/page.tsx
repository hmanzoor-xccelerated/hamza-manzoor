...
export default function Home() {
  const professionalServiceSchema = {
    ...
    description:
      "Production-ready full-stack software engineering and solutions architecture, specializing in Next.js, NestJS microservices, high-concurrency event queues (BullMQ), AWS cloud deployments, and enterprise AI orchestration (RAG/TTS).",
    knowsAbout: [
  ...
  const whatsHushSchema = {
    ...
    description:
      "WhatsHush is a privacy-first Google Chrome extension designed by Hamza Manzoor to blur sensitive chat details and profiles on WhatsApp Web dynamically on hover.",
    author: {
      "@type": "Person",
      name: "Hamza Manzoor",
      url: "https://hamza-manzoor.vercel.app/",
  ...
  const logauraSchema = {
    ...
    description:
      "Logaura is a highly optimized, custom console logging utility on the npm registry authored by Hamza Manzoor to streamline terminal outputs in microservices.",
    author: {
      "@type": "Person",
      name: "Hamza Manzoor",
      url: "https://hamza-manzoor.vercel.app/",
    ...
    <>
      ...
      <div className="relative min-h-screen bg-transparent text-slate-100 selection:bg-cyan-500/30 selection:text-cyan-100">
        <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6 border-b border-cyan-500/5">
          <p className="text-sm font-semibold tracking-[0.18em] text-cyan-200/90">
            HM
          </p>
        ...
        <section
          id="end"
          className="mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-6 text-center"
        >
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300">
            Horizontal scroll journey, project dashboard, and skills exploration
            complete.
          </p>
          <a
            href="#top"
        ...
        <footer className="mx-auto w-full max-w-6xl px-6 pb-12 pt-8 text-xs text-slate-500 border-t border-cyan-500/5 mt-10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p>
              © {new Date().getFullYear()} Hamza Manzoor.{" "}
              <a
                href="/faq"
                className="hover:text-cyan-300 transition text-[11px] underline ml-2"
              >
                FAQ / AEO Index
              </a>
            </p>
