...
const allProjects = [
  ...
  },
  {
    ...
    description: "Challenge: Slow checkout performance (over 3s) & cart loss. Solution: Built optimized Next.js checkout cache. Outcome: Dropped load time to <800ms and reduced cart abandonment by 30%.",
  ...
  },
  {
    ...
    description: "Challenge: Live tracking latency & unoptimized dispatch logs. Solution: Developed FastAPI + Redis transit cache and Mapbox integration. Outcome: Halved transit delivery tracking lag.",
